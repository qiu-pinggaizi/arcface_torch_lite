...
### 1.3 MobileFaceNet-Large (mbf_large, 6.3M)
...
所有模型保存在训练服务器 `output/` 目录下

| 目录名 | 说明 | 模型大小 | 状态 |
|--------|------|----------|------|
| `mbf` | MobileFaceNet 基线 | 8.1MB | 已完成 |
| `mbf_large` | MobileFaceNet Large | 25MB | 已完成 |
| `mbf_large_0.3ir_prune` | mbf_large 30% 剪枝 | 15MB | 已完成 |
| `mbf_large_0.4ir_prune` | mbf_large 40% 剪枝 | 15MB | 已完成 |
| `mbf_v3` | Phase 1: 轻量化基线 | 15MB | 已完成 |
| `mbf_v3_se` | Phase 2: +SE 注意力 | 16MB | 已完成 |
| `mbf_v3_se_distill` | Phase 3: 知识蒸馏 | 16MB | 已完成 |
| `mbf_v3_se_distill_prune` | Phase 3+: 蒸馏+剪枝 | 11MB | 已完成 |
| `glint360k_r100` | ResNet-100 基线 | 250MB | 已完成 |
| `r18` | ResNet-18 基线 | 92MB | 已完成 |
